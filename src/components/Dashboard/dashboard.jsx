...
import journeyImage from '../../assets/relationships.png';
...
const Dashboard = () => {
          ...
          >
            ...
            <div className="col-lg-6 col-md-12 mb-4">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Join a community of like-minded individuals looking to connect. Our platform offers easy-to-use tools to meet people and start meaningful conversations.
              </motion.p>
  ...
  <div className="footer-content">
    ...
    <div className="footer-title">Welcome Again from Sarang</div>
